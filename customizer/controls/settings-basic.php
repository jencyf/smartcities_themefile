...
$wp_customize->add_setting('optimizer[boxed_headfoot_full]', array(
	'type' => 'option',
	'default' => '',
	'sanitize_callback' => 'optimizer_sanitize_checkbox',
	'transport' => 'postMessage',
) );
			$wp_customize->add_control( new Optimizer_Controls_Toggle_Control( $wp_customize, 'boxed_headfoot_full', array(
				'label' => __('Keep Header & Footer Full Width','optimizer'),
				'section' => 'layout_section',
				'settings' => 'optimizer[boxed_headfoot_full]',
				'active_callback' => 'optimizer_layout_callback',
			)) );
...
//CONTENT BACKGOURND COLOR FIELD
$wp_customize->add_setting( 'optimizer[custom_sidebar]', array(
	'type' => 'option',
	'default' => '#ffffff',
	...
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new Optimizer_Sidebar_Control( $wp_customize, 'custom_sidebar', array(
				'label' => __('Custom Sidebars','optimizer'),
				'section' => 'basic_sidebar_section',
				'settings' => 'optimizer[custom_sidebar]',
			) ) );
...
// Site Content Font Weight
$wp_customize->add_setting( 'optimizer[content_font_id][font-weight]', array(
	'type' => 'option',
	'default' => '400',
	'sanitize_callback' => 'esc_attr',
	'transport' => 'postMessage',
) );
			$wp_customize->add_control('content_font_weight', array(
					'type' => 'select',
					'label' => __('Weight','optimizer'),
					'section' => 'basic_typography',
					'settings' => 'optimizer[content_font_id][font-weight]',
					'choices' => array(
						'300' => __('Thin','optimizer'),
						'400' => __('Regular','optimizer'),
						'600' => __('Bold','optimizer'),
						'800' => __('Extra Bold','optimizer'),
					),
			) );
...
// Site Content Font Weight
$wp_customize->add_setting( 'optimizer[ptitle_font_id][font-weight]', array(
	'type' => 'option',
	'default' => '600',
	'sanitize_callback' => 'esc_attr',
	'transport' => 'postMessage',
) );
			$wp_customize->add_control('ptitle_font_weight', array(
					'type' => 'select',
					'label' => __('Weight','optimizer'),
					'section' => 'basic_typography',
					'settings' => 'optimizer[ptitle_font_id][font-weight]',
					'choices' => array(
						'300' => __('Thin','optimizer'),
						'400' => __('Regular','optimizer'),
						'600' => __('Bold','optimizer'),
...
function optimizer_header_sidebar_callback( $control ) {
    $header_sidebar = $control->manager->get_setting('optimizer[head_sidebar]')->value();
     
    if ( $header_sidebar == 1 ) return true;

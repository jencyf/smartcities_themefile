...
require( get_template_directory() . '/plugins/customize-partial-refresh/php/class-wp-customize-partial-refresh-plugin.php' );
require( get_template_directory() . '/plugins/customize-partial-refresh/php/class-wp-customize-partial-refresh-widgets.php' );
require( get_template_directory() . '/plugins/customize-partial-refresh/php/class-wp-customize-partial-refresh-exception.php' );
